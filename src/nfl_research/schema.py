...
NUMERIC: tuple[str, ...] = (
    ...
    "sacks_taken", "sack_fumbles", "sack_fumbles_lost", "passing_air_yards",
    "passing_yac", "passing_first_downs", "passing_2pt",
    "carries", "rushing_yards", "rushing_tds", "rushing_fumbles",
    "rushing_fumbles_lost", "rushing_first_downs", "rushing_2pt",
    "receptions", "targets", "receiving_yards", "receiving_tds",
    "receiving_fumbles", "receiving_fumbles_lost", "receiving_air_yards",
    "receiving_yac", "receiving_first_downs", "receiving_2pt",
