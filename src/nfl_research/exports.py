...
PRETTY: dict[str, str] = {
    "rank_ppr": "Rank (PPR)", "rank_half": "Rank (Half)", "rank_std": "Rank (Std)",
    "rank_ppg": "Rank (PPG)", "rank_delta": "Rank Delta", "flex_rank": "FLEX Rank",
    "player_name": "Player", "player_id": "Player ID", "position": "Pos",
    "pos_label": "Pos Rank Label", "team": "Team", "teams": "Teams",
    "games": "G", "games_active": "G Active",
    "points_ppr": "PPR Pts", "ppg_ppr": "PPR PPG",
    "points_half": "Half PPR Pts", "ppg_half": "Half PPR PPG",
    "points_std": "Std Pts", "ppg_std": "Std PPG",
    "pos_rank": "Pos Rank", "pos_rank_ppg": "Pos Rank (PPG)",
    "vor_ppg": "VOR PPG", "vorp_total": "VORP Total", "tier": "Tier",
    "replacement_ppg": "Replacement PPG",
    "floor": "Floor (P10)", "ceiling": "Ceiling (P90)", "median_week": "Median Wk",
    "stdev": "Std Dev", "cv": "CV", "best_week": "Best Wk", "worst_week": "Worst Wk",
    "boom_weeks": "Boom Wks", "boom_rate": "Boom Rate",
    "bust_weeks": "Bust Wks", "bust_rate": "Bust Rate",
    "starter_weeks": "Starter Wks", "starter_week_rate": "Starter Wk Rate",
    "top5_weeks": "Top 5 Wks", "best_pos_finish": "Best Pos Finish",
    "touches": "Touches", "touch_pg": "Touches/G",
    "opportunities": "Opportunities", "opp_pg": "Opp/G",
    "target_share": "Target Share (Avg)",
    "scrim_yards": "Scrim Yds", "scrim_yds_pg": "Scrim Yds/G",
    "total_yards": "Total Yds", "total_yds_pg": "Total Yds/G",
    "total_tds": "Total TDs", "tds_pg": "TDs/G",
    "first_downs": "First Downs", "turnovers": "Turnovers",
    "fumbles_lost": "Fumbles Lost", "two_pt": "2PT Conv",
    "pts_per_touch": "Pts/Touch", "pts_per_opp": "Pts/Opp",
    "yards_per_touch": "Yds/Touch", "ypc": "YPC", "ypr": "YPR", "ypt": "YPT",
    "catch_rate": "Catch Rate", "td_rate": "TD Rate", "adot": "aDOT",
    "yac_per_rec": "YAC/Rec",
    "completions": "Comp", "attempts": "Att", "passing_yards": "Pass Yds",
    "passing_tds": "Pass TD", "interceptions": "INT", "comp_pct": "Comp %",
    "ypa": "YPA", "air_yards_pa": "Air Yds/Att", "td_int_ratio": "TD:INT",
    "sack_rate": "Sack Rate",
    "carries": "Carries", "rushing_yards": "Rush Yds", "rushing_tds": "Rush TD",
    "targets": "Targets", "receptions": "Rec", "receiving_yards": "Rec Yds",
    "receiving_tds": "Rec TD",
    "week": "Week", "opponent": "Opp", "week_pos_rank": "Wk Pos Rank",
    "fantasy_points_ppr": "PPR Pts", "fantasy_points": "Std Pts",
}

# Exported as decimals (0.6512) so Sheets' percent format is exact.
RATE_COLS = frozenset({
    "catch_rate", "boom_rate", "bust_rate", "starter_week_rate",
    "comp_pct", "td_rate", "target_share", "cv", "sack_rate",
})
...
def export_all(boards: dict[str, pd.DataFrame], folder: Path | str,
               only: list[str] | None = None, quiet: bool = False) -> list[Path]:
